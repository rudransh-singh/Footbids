  ...
  <div>
    <div class="page" >
      <v-card class="mx-auto overflow-hidden" >
        <div class="main elevation-8" >
        <div class="box1">
          <img class="player-photo" :src="'/img/' + Player.name + '.png'" v-bind:alt="Player.name" >
        </div>
          <div class="box2">
                  ...
                  <v-card class="mx-auto" max-width="600" outlined color="#42A5F5">
                    <v-list-item three-line>
                      <v-list-item-content>
                        ...
                        <v-list-item-title class="display-2">{{money}} M</v-list-item-title>
                      </v-list-item-content>
              ...
              <v-row align="center">
                <v-col>
                  <v-card class="elevation-12">
                    ...
                    <v-card-text>
                      <v-form>
                        <v-text-field v-model="money" label="PRICE(in M)" name="money" type="text" />
  ...
  methods: {
    submit() {
      ...
      axios.post("http://localhost:3000/bidDone", packag).then(res => {
        ...
        else if(res.data.message === "Money less than price") {
          alert("The Team doesn't have enough money to buy the player");
        }
